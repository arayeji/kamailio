...
typedef enum
{
	...
	IMS_REGISTRAR_CONTACT_DEACTIVATED, /**< Stale contact removed (same +sip.instance) per TS 24.229 */
...
extern reg_notification_list
		*notification_list; //< List of pending notifications
